...
<div id="root">
  <header id="top">
    <h1><a href="http://socialcircle.marketing/" accesskey="h"><img src="images/logo.png" alt="logo"></a></h1>
    <nav id="nav">
      <ul>
  ...
  <section id="content" class="a">
    ...
    <article id="contact">
					...
					<header class="heading-a">
						...
						<h3><span class="strong">Contact us</span></h3>

					</header>

					<form action="sendmail.php" method="post" id="ajax-form-send">
						...
						<fieldset>
							...
							<p>
									...
									<label for="cc">Phone Number</label>

									<input type="tel" id="cc" name="phone" required>
                            ...
                            <p>
									...
									<input type="tel" id="cc" name="subject" required>
							...
							<p>
								...
								<textarea id="ce" name="message" required></textarea>

							</p>

							<p><input type="submit" name="submit" id="submit" value="Send"><!--<button type="submit">Send</button>--></p>
							<?php /*?><p><?php if($_REQUEST['mail']=='success'){echo "Your query has been submitted successfully!";} if($_REQUEST['mail']=='fail'){echo "Sorry! Please try again later.";} ?></p><?php */?>
    ...
    <div id="content">
      ...
      <div class="r">
       ...
       <!-- <br />
        ...
        <br />
        <div class="cont-text blue"><!--<i class="fa fa-envelope-o"></i>--><a href="mailto:support@socialcircle.marketing"> Support - support@socialcircle.marketing</a></div>
      </div>
    </div>
