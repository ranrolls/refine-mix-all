...
class MembercheckinViewAddorganization extends JViewLegacy   
{
	public function display($tpl = null)
	{
		...
		$model 	             = $this->getModel();
               ...
               if($postData['task']=='addorganization') 
	       {   //echo "vishalsubcateg";
	        $saveSubRespons 	  = $model->saveOrganizationData($postData);
	...
	public function validate($data)
	{
		...
		$msg	 = array();
			...
			$msg['organizationName']="Organization name is required field";
		}
