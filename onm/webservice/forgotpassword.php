...
<tr>    <td height="20" align="left" valign="top"> <img src="http://'.$serverurl.'" alt=" " class="img" border="0" align="left" style="display:block;width:100%"></td>    </tr>
     ...
     <tr><td   align="center" valign="top">
       ...
       <tr><td align="left" valign="top"><span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:20px; color:#343434; font-weight:normal;">Dear <span style="color:#343434;">user,</span><br /><br /> Please find your username below. You can use the ONM app to login to your account.</span>
<br /><br />
...
29 Tai Seng Avenue, #06-04A Natural Cool Lifestyle Hub, Singapore 534119.</span>
  ...
  <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="full_480" >
	...
	<td width="180" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#ffffff;"> Call us on: (65) 6479 7723 </td> </tr>
      ...
      <tr> 
     <td width="13"><img src="http://'.$serverurl.'" width="13" height="10" /></td><td width="5"></td>     
     ...
     <tr> 
       ...
       <tr> <td align="center" valign="middle" height="37 " bgcolor="#2a4c75" > <span style="font-family:Arial, Helvetica, sans-serif; font-size:12px  ; color:#ffffff;-webkit-text-size-adjust: none;">Copyright © 2016. ONM All rights reserved </span></td>  
         </tr> 
...
#####################################################
				...
				sendmail($email,$subject,$msg,"info@onm.com");
