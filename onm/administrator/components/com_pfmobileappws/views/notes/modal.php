<?php
/**
* @version		$Id:modal.php 1 2015-12-09 05:18:21Z  $
...
$function  = $input->getCmd('function', 'jSelectNote');
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn  = $this->escape($this->state->get('list.direction'));
?>
<form action="<?php echo JRoute::_('index.php?option=com_pfmobileappws&view=notes&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm" class="form-inline">
