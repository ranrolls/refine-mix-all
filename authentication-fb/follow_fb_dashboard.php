...
//echo "select * from user_authentication_fb_details where email='".$to_email."' ";
  $str=mysql_query("select * from user_authentication_fb_details where email='".$to_email."' "); 
...
//get input field values data to be sent to server // 'user_demo_website_link' : $('input[name=demo_website_link]').val(),
 ...
 //Ajax post data to server
            ...
            $.post('follow_fb_contact_me.php', post_data, function(response){  
				...
				if(response.type == 'error'){ //load json data from server and output message     
					output = '<div class="error">'+response.text+'</div>';
                                    ...
                                    window.location.href = 'follow_fb_success.php'; 
    ...
    <div class="form_box container center-block">
      ...
      <div class="col-lg-6 center-block " style="float:none"  id="contact_form">
        ...
        <div class="row"> 
            ...
            <label style="font-size: large;">Mock Up Approval</label><br/>
