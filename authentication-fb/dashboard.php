...
//get input field values data to be sent to server // 'user_demo_website_link' : $('input[name=demo_website_link]').val(),
  ...
  <article id="welcome">
    <div class="form_box container center-block">
      <div class="col-lg-6 center-block " style="float:none"  id="contact_form">
        <div class="row">
          <div class="col-lg-6">
            <input type="text" name="fname" id="fname" required="true" value=""  placeholder="First Name" class="input-field">
          </div>
          <div class="col-lg-6">
            <input type="text" name="lname"  id="lname" required="false" value="" placeholder="Last Name" class="input-field">
          </div>
          <div class="clearfix"></div>
          <div class="col-lg-12">
            <input type="email" name="email" required="true" value="" placeholder="Email ID" class="input-field">
          </div>
          <div class="clearfix"></div>
          <div class="col-lg-12">
           
            <input type="text" name="phone" required="true" value="" placeholder="Phone No" class="input-field">
          </div>
          <div class="col-lg-12">
            <input type="text" class="input-field" required="true" name="business_name"  value="" placeholder="Business Name">
          </div>
          <div class="clearfix"></div>
         <!-- <div class="col-lg-12">
            <input type="text" class="input-field" required="true" name="demo_website_link"  value="" placeholder="Website">
          </div>-->
 <div class="col-lg-12">
            <input type="text" class="input-field" required="true" name="address"  value="" placeholder="Address">
          </div>
          <div class="col-lg-12">
            <input type="text" class="input-field" required="true" name="date_of_order"  value="" placeholder="Date">
          </div>
