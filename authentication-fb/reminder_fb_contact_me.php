...
Hi '.$user_fname.',<br/><br/>
This is an gentle reminder to have a look at the below Mock-up for Facebook App for '.$user_business_name.'. All you have to do is authorize Social Circle to integrate the Facebook App on your official Facebook Page. It only takes a minute and is safe. Please follow the simple steps highlighted on the link below:<br/><br/>

<b>'.$user_business_name.'</b> - <a href="'.$user_demo_website_link.'">'.$user_demo_website_link.'</a><br/><br/>

<b>Instructions to authorize access to Facebook Page:</b><br/><br/>

<strong>Step 1 </strong> - <br/>
After logging into your Facebook account, click on top corner arrow and from the drop down links choose "Create page"
<br/><br/><img src="images/screenshot-1.jpg" style="max-width:100%;"> <br/><br/>

<strong>Step 2</strong> - <br/>
On the "Create a Page", choose option Company, Organization or Institution section. Then select "Company" and Type your desired name for the App Page. e.g. Judy 
<br/><br/><img src="images/screenshot-2.jpg" style="max-width:100%;"> <br/><br/>

<strong>Step 3</strong> - <br/>
Skip all the 4 stages
<br/><br/><img src="images/screenshot-3.jpg" style="max-width:100%;"> <br/><br/>

<strong>Step 4</strong> - <br/>
After skipping above 4 stage, your App page will be create. Click on "Settings".
<br/><br/><img src="images/screenshot-4.jpg" style="max-width:100%;"> <br/><br/>

<strong>Step 5</strong> - <br/>
Click on "Page Roles" to initiate Admin Permission.
<br/><br/><img src="images/screenshot-5.jpg" style="max-width:100%;"> <br/><br/>

<strong>Step 6</strong> - <br/>
Enter our email id "fbapps@socialcircle.marketing" to give us permission to edit the page created. Choose "Admin" from dropdown. Click "Save".
<br/><br/><img src="images/screenshot-6.jpg" style="max-width:100%;"> <br/><br/>

<strong>Step 7</strong> - <br/>
A pop-up box will appear prompting for the password, enter your Facebook password.
<br/><br/><img src="images/screenshot-7.jpg" style="max-width:100%;"> <br/><br/>
...
$mail->Subject    ='Attn: Gentle Reminder - Facebook App for '.$user_business_name.'';
