...
Thank you for signing up with Social Circle Web on <b>'.$dated.'</b>. I am Judy Cooper, your account manager from the client success team. We appreciate your confidence and look forward to working together with you to provide a stronger online presence for your business. Please review the details of your business information and subscription below:<br/><br/>
...
$datquery= "select * from user_authentication_details where email='".$user_email."'";
$res= mysql_query($datquery);
  
while($finaldate= mysql_fetch_assoc($res)){

$follow1_book_date=$finaldate['contact_date'];
$date_of_order=$finaldate['date_of_order'];
...
This is an gentle reminder to check the below email with Design Mock-up. Do share your feed and other required details as mentioned below.
<br/><br/>
<b>'.$user_business_name.'</b> - <a href="'.$user_demo_website_link.'">'.$user_demo_website_link.'</a> <br/> <br/>
I am sure you are as excited as we are to launch the new website for '.$user_business_name.'. All you have to do is call your current domain provider and have them update the DNS A record to point to 205.186.138.145. Alternatively, we can secure a domain name for your business.<br/><br/>

Please let me know if we can provide assistance in getting your website live! <br/><br/>
...
--------------------------------------------- <br/><br/>
 ...
 Hi '.$user_fname.',<br/><br/>
Our creative design team has put together the look and feel of the new website for '.$user_business_name.'.Please review from links below and provide your feedback and approval. <br/><br/>
<b>'.$user_business_name.'</b> - <a href="'.$user_demo_website_link.'">'.$user_demo_website_link.'</a> <br/> <br/>
I am sure you are as excited as we are to launch the new website for '.$user_business_name.'. All you have to do is call your current domain provider and have them update the DNS A record to point to 205.186.138.145. Alternatively, we can secure a domain name for your business.<br/><br/>
...
Thank you for signing up with Social Circle Web on '.$follow1_book_date.'. I am Judy Cooper, your account manager from the client success team. We appreciate your confidence and look forward to working together with you to provide a stronger online presence for your business. Please review the details of your business information and subscription below:<br/><br/>
...
$mail->Subject    ='Attn: Gentle Reminder - New website for '.$user_business_name.'';
...
/*$str=mysql_query("INSERT INTO sociacir_emailcrm.user_authentication_details(id,fname,lname,email,phone,date_of_order,address,business_name,demo_website_link,contact_date,follow1,follow2,follow2_date,verified,status) VALUES ('','".$user_fname."','".$user_lname."','".$user_email."','".$user_phone."','".$dated."','".$user_address."','".$user_business_name."','".$user_demo_website_link."','','','YES',now(),'".$activation."','1')");

$last_inserted_id=mysql_insert_id();  */


$reminder_date= date("j F Y");

 
$sql_follow_status = "UPDATE user_authentication_details SET demo_website_link='".$user_demo_website_link."',
                      reminder_status='YES',reminder_date='".$reminder_date."'
