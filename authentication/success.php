  ...
  <article id="welcome">
    <div class="form_box container center-block">
      <div class="col-lg-6 center-block" style="float:none">
        <div class="row">
          <div class="col-lg-12">
            <div style="background:#fff; color:#000; padding:10px; border-radius:5px; font-size:14px; margin-bottom:25px; font-weight:normal; color:green; text-align:center "> Email sent successfully. </div>
          </div>
          <div class="clearfix"></div>
          <div class="col-lg-12">
		  <a href="menu.php"> <input type="submit" name="submit" id="submit_btn"  value="Back" ></a>
