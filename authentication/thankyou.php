...
<div id="root">
  <header id="top">
    <h1><a href="index.html" accesskey="h"><img src="images/logo.png" alt="logo"></a></h1>
    <nav id="nav">
      <ul>
        <li style="padding-top:8px; color:#fff; ">customized facebook apps & Social Media Campaigns</li>
        <li class="a"><a class="top-nav-button" accesskey="5" href="https://www.2checkout.com/checkout/purchase?sid=102636016&quantity=1&product_id=1" target="_blank">Start for $1</a> <em>(5)</em></li>
      </ul>
    </nav>
  </header>
  <article id="welcome">
    <div class="form_box container center-block">
      <div class="col-lg-6 center-block" style="float:none">
        <div class="row">
          <div class="col-lg-12">
            <div style="background:#fff; color:#000; padding:10px; border-radius:5px; font-size:14px; margin-bottom:25px; font-weight:normal; color:green; text-align:center "> Thank you for authentication and agreement to our terms & conditions.You will receive an email with order summery and your approval. </div>
          </div>
          <div class="clearfix"></div>
          <div class="col-lg-12">
		   
           <!-- <input type="submit" name="submit" id="submit_btn"  value="Back" >-->
          </div>
